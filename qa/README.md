...
To actual make those steps do something, an automation tester will 'glue' those steps to Selenium code.     
...
\---src
    ...
    \---test
        ...
        |       |
        |       +---feature_steps
        |       |       Steps_createAccount.java
        |       \---page_object_model
        |               POM_createAccount.java
        |               POM_LoginPage.java
        |
        \---resources
            +---data
            \---features
                    TestSuite_CreateAccount.feature
                    TestSuite_LoginFailure.feature
