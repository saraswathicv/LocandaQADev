...
public class Webdriver_builder implements WebDriver {
	...
	private final int millisecond_performance_threshold = 50000;
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	public Webdriver_builder(	
		...
		if (selenium_grid_enabled.equalsIgnoreCase("no")) {
			...
			// capabilities
			/*
			 * options.setCapability(CapabilityType.BROWSER_NAME, browser); if
			 * (!browser_version.equals(""))
			 * options.setCapability(CapabilityType.BROWSER_VERSION, browser_version); if
			 * (!operating_system.equals(""))
			 * options.setCapability(CapabilityType.PLATFORM_NAME, operating_system); if
			 * (!operating_system.equals("")) options.setCapability(CapabilityType.PLATFORM,
			 * operating_system);
			 */
